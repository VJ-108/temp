					...
					{[
						{
							...
							desc: "Pick from AI/ML powered project ideas.",
						},
						{
							step: "2",
							title: "AI Generates Template",
							desc: "Get auto-created code templates & folder structures.",
						},
						{
							step: "3",
							title: "Build Step by Step",
							desc: "Complete features guided by AI mentor.",
						},
						{
							step: "4",
							title: "Get Certified",
							desc: "Earn badges & showcase your project.",
						},
					].map((item) => (
						<div
							key={item.step}
			...
			<section className="py-24 bg-gray-950 text-white text-center relative z-10">
				...
				<div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto px-6">
					{[
						{
							title: "AI Mentor 🤖",
							desc: "Debugs errors, explains code, and gives hints.",
						},
						{
							title: "Built-in Code Editor ⌨️",
							desc: "Code directly inside the platform.",
						},
						{
							title: "Step-by-Step Tasks 📑",
							desc: "Projects broken into achievable steps.",
						},
						{
							title: "Code Auto-Checking ✅",
							desc: "AI tests your code in real-time.",
						},
						{ title: "SDG Linking 🌍", desc: "Projects aligned with UN SDGs." },
						{
							title: "ML Project Templates ⚡",
							desc: "Auto-generated boilerplate & roadmap.",
						},
					].map((f) => (
						<div
							key={f.title}
